  ...
  return (
    <Card className="border-emerald-900/20 ">
      <CardHeader>
        ...
        <CardDescription>
          Set your daily availability for patient aappointments
        </CardDescription>
      </CardHeader>
      <CardContent>
        {!showForm ? (
          <>
            <div className="mb-6">
              ...
              {slots.length === 0 ? (
                ...
                <div>
                  {slots.map((slot) => {
                    return (<div key={slot.id} className="flex items-center p-3 rounded-md bg-muted/20 border border-emerald-900/20 ">
